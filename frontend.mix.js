...
function front() {
    ...
    //404
    mix.sass(srcSassFrontend + 'pages/404.scss', destCssFrontend);
    ...
    // login
    mix.sass(srcSassFrontend + 'pages/login.scss', destCssFrontend);

    // forgot
    mix.sass(srcSassFrontend + 'pages/forgot.scss', destCssFrontend);
