...
class JoshController extends Controller
{
    ...
    public function showHome()
    {
        ...
        //finally return view
        if (Sentinel::check()) {
            return view('admin.index', compact('analytics_error', 'users_chart', 'blog_count', 'user_count', 'users', 'blogs', 'visitors', 'pageVisits', 'month_visits', 'year_visits', 'user_roles', 'userTypes'));
        } else {
            return redirect('admin/signin')->with('error', 'You must be logged in!');
        }
    }
