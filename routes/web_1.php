...
Route::group(
    ...
    function () {
        ...
        Route::post('2_dieuchuyen_hc','dieuChuyenHoaChatController@index');
        Route::get('2_hc_sd','baoCaoHangNgayController@index');
        Route::post('2_hc_sd','baoCaoHangNgayController@store');
...
Route::group(
    ...
    function() {
        ...
        Route::get('1_ds_nk','danhSachHoaChatController@index');
        Route::get('index','tonKhoController@index');
