...
use App\Http\Controllers\QuanKho\excelController;
...
use App\Http\Controllers\QuanKho\tonKhoController;
...
use App\Http\Controllers\QuanPhong\duTruController;
...
Route::group(
    ...
    function () {
        ...
        Route::post('dutru','duTruController@store');
...
Route::get('loadcanhbao','canhBaoController@index');
Route::get('loadbieudo/{id}','dataChart@show');
...
Route::group(
    ...
    function() {
        ...
        // });
        Route::get('/loadtable','ChartsController@index');
        Route::get('/','indexController@index');
        ...
        Route::post('1_nhatky_sd/{id}','baoCaoMuonController@update');
        Route::get('ecxelupload','excelController@index');
        Route::post('ecxelupload','excelController@store');
        Route::get('1_suaxoa_hc','danhSachNhapKhoController@show')->name('suaxoahc');
        Route::get('1_suaxoa_hc/edit/{id}','danhSachNhapKhoController@edit');
        Route::post('1_suaxoa_hc/edit/{id}','danhSachNhapKhoController@update');
        Route::get('1_suaxoa_hc/delete/{id}','danhSachNhapKhoController@destroy');
        Route::get('tonkho123','tonKhoController@index');
    });
