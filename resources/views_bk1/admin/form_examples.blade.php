                ...
                <div class="card " id="hidepanel1">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="#">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-3 col-lg-3 col-12 control-label" for="email">Your
                                        E-mail</label>
                                    <div class="col-md-9 col-lg-9 col-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-3 col-lg-3 col-12 control-label" for="message">Your
                                        message</label>
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <textarea class="form-control resize_vertical" id="message" name="message"
                            ...
                            <div class="form-position">
                                <div class="row">
                                    <div class="col-md-12  col-sm-12 col-12  col-lg-12 text-right">
                                        <button type="submit" class="btn btn-primary btn-sm" value="gửi">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="#" method="">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-md-3 col-lg-3 col-12 control-label" for="name1">E-mail
                                            Address</label>
                                        <div class="col-md-9 col-lg-9 col-12">
                ...
                <div class="card-body">
                    <form role="form" id="form_controls">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="optionsRadios" class="custom-radio" id="optionsRadios1"
                                        value="option1">&nbsp; Radio 1</label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="optionsRadios" class="custom-radio" id="optionsRadios2"
                                        value="option2">&nbsp; Radio 2</label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="optionsRadios" class="custom-radio" id="optionsRadios3"
                                        value="option3">&nbsp; Radio 3</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Inline Radio Buttons</label>
                            <label class="radio-inline">
                                &nbsp;<input type="radio" class="custom-radio" name="optionsRadiosInline"
                                    id="optionsRadiosInline1" value="option1">&nbsp; 1</label>
                            <label class="radio-inline">
                                <input type="radio" class="custom-radio" name="optionsRadiosInline"
                                    id="optionsRadiosInline2" value="option2">&nbsp;2</label>
                            <label class="radio-inline">
                                <input type="radio" class="custom-radio" name="optionsRadiosInline"
                                    id="optionsRadiosInline3" value="option3">&nbsp; 3</label>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div>
                                    <span class="btn btn-secondary btn-file">
                                        ...
                                        <span class="fileinput-exists">Change</span>
                                        <input type="file" name="..."></span>
                                    <a href="#" class="btn btn-secondary fileinput-exists color_a ml-2"
                                        data-dismiss="fileinput">Remove</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <form role="form">
                        <fieldset disabled>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" class="custom-checkbox" disabled>&nbsp; Disabled
                                    Checkbox</label>
                            </div>
