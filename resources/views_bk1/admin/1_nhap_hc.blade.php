            ...
            <div class="card filterable" style="overflow:auto;">
                <div class="card-header bg-success text-white clearfix  ">
                    ...
                    <div class="float-right">
                        <button type="button" class="btn btn-warning btn-sm hvr-wobble-vertical" id="">Nhập từ
                            excel</button>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="ten_hoa_chat[0]" type="text" placeholder="Tên Hóa Chất"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-3 col-lg-3 col-12 control-label" for="name">Đơn
                                        Vị</label>
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="don_vi_tinh[0]" type="text" placeholder="Đơn vị"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-3 col-lg-3 col-12 control-label" for="name">Quy
                                        ...
                                        Gói</label>
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="don_vi_dong_goi[0]" type="text"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="noi_san_xuat[0]" type="text" placeholder="Nước sản xuất"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-3 col-lg-3 col-12 control-label" for="name">Công Ty
                                        ...
                                        Ứng</label>
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="ten_cong_ty_cung_ung[0]" type="text"
