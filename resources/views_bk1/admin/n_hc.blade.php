                    ...
                    <div class="card-body table-responsive-lg table-responsive-sm table-responsive-sm">
                        <table class="table table-striped table-bordered width100" id="table4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" id="row-1-text" name="row-1-number" value="Việt Nam">
                                </td>
                                <td>
                                    <input type="text" class="form-control" id="row-1-text" name="row-1-number" value="Nam Việt - Lintech">
                                </td>
                                <td>
                                	<div class="form-group">
                               			<div class="input-group">
                                    		<input class="flatpickr flatpickr-input form-control" type="text" placeholder="Chọn ngày">
                               			</div>
                               		</div>
                            	</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select size="1" id="row-1-office" name="row-1-office">
                                        <option value="Hộp">Ống</option>
                                        <option value="Ống" selected="selected">Hộp</option>
                                        <option value="Kit">Kit</option>
                                        <option value="Bộ">Bộ</option>
                                    </select>
                                </td>
                                <td>
                                    <select size="1" id="row-1-office" name="row-1-office">
                                        <option value="12 x 3ml" >12 x 3ml</option>
                                        <option value="100rxn/Hộp" selected="selected">100rxn/Hộp</option>
                                        <option value="50 test/bộ">50 test/bộ</option>
                                        <option value="100 pư/bộ">100 pư/bộ</option>
                                        <option value="100 rxn/bộ">100 rxn/bộ</option>
                                        <option value="48 test">48 test</option>
                                ...
                                <td>
                                    <input type="text" class="form-control" id="row-1-number" name="row-1-number" value="400">
                                </td>
                                <td>
                                    <input type="text" class="form-control" id="row-1-text" name="row-1-number" value="Mỹ">
                                </td>
                                <td>
                                    <input type="text" class="form-control" id="row-1-text" name="row-1-number" value="Nam Việt - Lintech">
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select size="1" id="row-1-office" name="row-1-office">
                                        <option value="12 x 3ml" >12 x 3ml</option>
                                        <option value="100rxn/Hộp">100rxn/Hộp</option>
                                        <option value="50 test/bộ" selected="selected">50 test/bộ</option>
                                        <option value="100 pư/bộ">100 pư/bộ</option>
                                        <option value="100 rxn/bộ">100 rxn/bộ</option>
                                        <option value="48 test">48 test</option>
                                        <option value="72 test">72 test</option>
                                ...
                                <td>
                                    <input type="text" class="form-control" id="row-1-number" name="row-1-number" value="600">
                                </td>
                                <td>
                                    <input type="text" class="form-control" id="row-1-text" name="row-1-number" value="Mỹ">
                                </td>
