                ...
                <table class="table table-bordered width100" id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$ds['hanSuDung']}}</td>
                            <td>
                            <a href='edit/{{$ds['maLoHoaChat']}}'><i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="sửa hóa chất"></i></a>
                            <a href='delete/{{$ds['maLoHoaChat']}}' data-id="" data-toggle="modal" data-target="#delete_confirm"><i class="livicon" data-name="user-remove" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="xóa hóa chất"></i></a>
                        </td>
                        </tr>
                        @endforeach
                    </tbody>
