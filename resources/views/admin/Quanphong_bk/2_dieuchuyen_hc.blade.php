                        ...
                        <form class="form-horizontal" method="post" action="2_dieuchuyen_hc">
                            ...
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <select name="ma_phong" id="select21" class="form-control select2">
                                            ...
                                            <option value="{{$ds['phong']->ma_phong}}">{{$ds['phong']->ten_phong}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <select id="select21" class="form-control select2">
                                            ...
                                            <option value="{{$ds['hoachat']->ma_danh_muc_hoa_chat}}">{{$ds['hoachat']->ten_hoa_chat}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="so_luong" type="text" placeholder="Số lượng" class="form-control"></div>
                                </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
