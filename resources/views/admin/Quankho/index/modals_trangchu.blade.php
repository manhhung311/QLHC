            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="quankho/phanhoachat">
                    ...
                    <div class="card-body table-responsive-lg table-responsive-sm table-responsive-md">
                        <div class="float-mid">
                            <label for="select1">Chọn Phòng</label>
                            <select name="ma_phong" class="form-control" id="select1" required >
                                @foreach( $dsp as $p )
                        ...
                        <table class="table table-striped table-bordered" width="100%" id="table2">
                            <thead>
                                <tr>
                                    ...
                                    <th>Số Lượng Xuất <span>(Đơn vị tính)</span></th>
                                    <th>
                            ...
                            @foreach($dshc as $ds) 
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        name="list[{{$ds['hoaChat']->ma_lo_hoa_chat}}]" min="0" max="{{$ds['soLuongConLai']}}">
                                    </td>
                                    <td>
                                        <label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm" onclick="checkXuat()">Xuất</button>
                    </div>
                </form>
            </div>
        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-lg-9 col-12">
                                                    <input id="name" name="ten_hoa_chat" type="text"
                                                        placeholder="Tên Hóa Chất" class="form-control" required >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-lg-9 col-12">
                                                    <input id="name" name="so_luong" type="number"
                                                        placeholder="Số lượng" class="form-control" min="0" required >
                                                </div>
                                            </div>
                                        </div>
