                    ...
                    <div id="rootwizard">
                        ...
                        <div class="tab-content">
                            ...
                            <ul class="pager wizard">
                                ...
                                <li class="next finish" style="display:none;"><a class="btn btn-raised btn-success btn-large" href="{{ route('quankho.suaxoahc') }}">Quay Lại</a></li>
                                <li class="next finish" style="display:none;"><button class="btn btn-raised btn-success btn-large"
                                type="submit">Sửa</button></li>
                            </ul>
                        </div>
                    </div>
                    {!! Form::close() !!}
