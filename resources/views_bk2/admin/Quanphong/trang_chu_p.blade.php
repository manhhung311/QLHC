                                ...
                                <table class="table table-striped table-bordered" id="table5" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td class="money">{{ $ds['suDung']->so_luong_hoa_chat_nhap_ve - $ds['suDung']->so_luong_su_dung}}</td>
                                            <!-- <td>
                                ...
                                <table class="table table-striped table-bordered" id="table4" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" class="money form-control" id="row-1-number"
                                                    name="list[{{$ds['suDung']->ma_su_dung_hoa_chat}}]" min="0" value="{{$ds['duTru']}}">
                                                <input type="hidden" name="check[]" value="{{$ds['suDung']->ma_su_dung_hoa_chat}}"></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
