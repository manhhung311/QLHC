...
Route::group(
    ...
    **************************/
        ...
        /*routes for Consorzi*/
        Route::group(
            ['prefix' => 'consorzi', 'as' => 'consorzi.', 'namespace' => 'Arisi'],
            function () {
                Route::get('/', 'ConsorziController@index')->name('index');
                Route::get('data', 'ConsorziController@data')->name('data');
                Route::post('update', 'ConsorziController@update')->name('update');
                Route::post('delete', 'ConsorziController@delete')->name('delete');
            }
        );

        /*routes for gruppi*/
        Route::group(
            ['prefix' => 'gruppi', 'as' => 'gruppi.', 'namespace' => 'Arisi'],
            function () {
                Route::get('/', 'GruppiController@index')->name('index');
                Route::get('data', 'GruppiController@data')->name('data');
                Route::post('update', 'GruppiController@update')->name('update');
                Route::post('delete', 'GruppiController@delete')->name('delete');
            }
        );

        /*routes for tipo_intervento*/
        Route::group(
            ['prefix' => 'tipo_intervento', 'as' => 'tipo_intervento.', 'namespace' => 'Arisi'],
            function () {
                Route::get('/', 'Tipo_interventoController@index')->name('index');
                Route::get('data', 'Tipo_interventoController@data')->name('data');
                Route::post('update', 'Tipo_interventoController@update')->name('update');
                Route::post('delete', 'Tipo_interventoController@delete')->name('delete');
            }
        );

        /*routes for trasportatori*/
        Route::group(
            ['prefix' => 'trasportatori', 'as' => 'trasportatori.', 'namespace' => 'Arisi'],
            function () {
                Route::get('/', 'TrasportatoriController@index')->name('index');
                Route::get('data', 'TrasportatoriController@data')->name('data');
                Route::post('update', 'TrasportatoriController@update')->name('update');
                Route::post('delete', 'TrasportatoriController@delete')->name('delete');
            }
        );
